              ...
              <form role="form" method="POST" action="/admin/users">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('name') is-invalid @enderror" id="code" placeholder="ادخل اسم المستخدم" name="name" value="{{Request::old('name')}}">
                    @error('name')
                  ...
                  <div class="form-group">
                    ...
                    <input type="email" class="form-control  @error('email') is-invalid @enderror" id="email" placeholder="أدخل البريد الآلكتروني" name="email">
                    @error('email')
                      <span class="invalid-feedback" role="alert">
                          <strong>{{ $message }}</strong>
                      </span>
